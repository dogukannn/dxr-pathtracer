...
void D3D12RaytracingSimpleLighting::BuildAccelerationStructures()
{
    ...
    AllocateUploadBuffer(device, &instanceDesc[0], sizeof(instanceDesc), &instanceDescs, L"InstanceDescs");
